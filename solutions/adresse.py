...
# Mit dem limit parameter wurde hier eingestellt, dass nur das erste von
# möglicherweise sehr vielen Suchergebnissen zurückgeliefert werden soll.
...
# ausserhalb kann das verify=False weggelassen werden
...
webbrowser.open_new_tab(rf"https://map.geo.admin.ch/?X={x}&Y={y}&zoom=12&crosshair=marker")
